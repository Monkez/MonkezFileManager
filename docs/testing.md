...
Khi sửa logic file system, cần thêm test cho edge case tương ứng: path không tồn tại, tên không hợp lệ, trùng tên, copy/move thư mục, cancel task và lỗi quyền truy cập.
